...
var chakravyuha = 
{
	...
	data:
		[
			...
			<br/>,<br/>,
			<b>FAQ</b>,	<br/>,
			<b>1)&emsp;How many members in a group?</b>,
			<br/>,
			<b>A :&emsp;</b>, `Four`,
			<br/>,
			<b>2)&emsp;Can we use readymade kits?</b>,
			<br/>,
			<b>A :&emsp;</b>, `No`,
			<br/>,
			<b>3)&emsp;Will the organizers provide battery source?</b>,
			<br/>,
			<b>A :&emsp;</b>, `No. the participants need to bring their own.`,
			<br/>,
			<b>4)&emsp;How many chances per team?</b>,
			<br/>,
	...
	contacts:
		[
			`Amrutha Manoharan : 09566186673 (evd15i020@iiitdm.ac.in)`,	<br/>,
			`Rohan Kumar Panda: 08249639668 (mfd15i013@iiitdm.ac.in )`,	<br/>,
...
var warOfWatts = 
{
	...
	contacts:
	[
		`Aditya Pharande: 09566219050 / 08605575742 (edm15b012@iiitdm.ac.in)`,	<br/>,
		`Sakshi Vastrad: 09962287327/ 08308751733 (evd15i008@iiitdm.ac.in)`,	<br/>,
		`Vyshak Nath C A: 09846527056 (evd15i016@iiitdm.ac.in)`
	],
}
...
var mayasrishti = 
{
	...
	contacts:
	[
		`Yutika Kulwe: 9920289853 (ced15i017@iiitdm.ac.in)`,	<br/>,
...
var duetDance = 
{
	...
	[
		...
		<br/>,
		<b>A :&emsp;</b>, `Two, for duet and group. Three, for solo.`,
		<br/>,
		<b>3) Why should I participate?</b>,
		<br/>,
		<b>A :&emsp;</b>, `Prize money upto 50k!`,
		<br/>
	],
	contacts:
	[
		`Manasa: 9566187833 (edm15b021@iiitdm.ac.in)`,	<br/>,
...
var drishyam = 
{
	...
	contacts:
	[
		`A Aravind: 7904787923 (mdm15b033@iiitdm.ac.in)`,	<br/>,
...
var battleZone = {
  ...
  score ) is the winner.`,
	...
	<br/>,
	<b>A :&emsp;</b>, `Your teammates and your brain.`,
	<br/>,
	<b>4) So, what all components will be available?</b>,
	<br/>,
	<b>A :&emsp;</b>, `The standard equipment in workshop, other materials to work with
  will be mentioned to the finalist on spot, on
  the day of event.`,
  <br/>,
	<b>5) Is it for UG/PG/PhD?</b>,
	<br/>,
	<b>A :&emsp;</b>, `Any team with its team members having valid Samgatha ID can
