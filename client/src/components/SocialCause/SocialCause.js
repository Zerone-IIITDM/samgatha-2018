		...
		return(
			<div className="scContainer">
				...
				<div className="scContent">
	              ...
	              Depression is an often ignored, but extremely common mental disorder that has a severe impact on the people it affects. Different from merely being sad or down, depression leaves you unable to feel anything. The truth is, most people are likely to have an episode of depression over their lifetime. Through counseling and medication (in some exreme cases), these people can face significant relief. However, in India, there is too much misinformation and lack of awareness of the condition, and a stigma is associated with getting psychiatric help.
	      		</div>
	      		<div className="scContent">
