		...
		return(
			<div className="scContainer">
				...
				<div className="scContent">
	      		...
	      		<div className="scContent">
	              <div style={{color:'#b1ff64',fontWeight:'700'}}>SAMGATHA 2018's</div> social motivation is to spread awareness about mental health under the theme "Depression is curable". To contribute to this cause, we have come up with an idea to support a foundation, SNEHA.
	      		</div>
	      		<div className="scContent">
